...
void QGCPalette::_buildMap()
{
    ...
    DECLARE_QGC_COLOR(buttonBorder,         "#9d9d9d", "#A4133C", "#707070", "#adadb8")
    DECLARE_QGC_COLOR(buttonText,           "#9d9d9d", "#333333", "#A6A6A6", "#ffffff")
    DECLARE_QGC_COLOR(buttonHighlight,      "#e4e4e4", "#A4133C", "#3a3a3a", "#A4133C")
    ...
    DECLARE_QGC_COLOR(groupBorder,          "#bbbbbb", "#A4133C", "#707070", "#707070")
